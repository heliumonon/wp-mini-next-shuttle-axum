...
/**
 * CheckoutConfig configuration for checkout.
 */
...
/**
 * DownloaderConfig configuration for checkout.
 */
...
/**
 * StoryNotFoundConfig configuration for checkout.
 */
export type StoryNotFoundConfig = {
    effects: EffectsConfig;
};

/**
 * DownloadingConfig configuration for checkout.
 */
export type DownloadingConfig = {
    effects: EffectsConfig;
};
...
export type OnceUIConfig = {
    ...
    downloadingStory: DownloadingConfig,
};
