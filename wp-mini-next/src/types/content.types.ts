...
/**
 * Checkout Section
 * @description The below information will be displayed on the Home page in Checkout block
 */
export type Checkout = {
    /** Whether to display the checkout section */
    display: boolean;
    /** Title of the checkout   */
    title: React.ReactNode;
};
...
export type Downloader = {
    /** Whether to display the Downloader section */
    display: boolean;
    /** Title of the Downloader   */
    title: React.ReactNode;
};

/**
 * StoryNotFound Section
 * @description The below information will be displayed on the Home page in StoryNotFound block
 */
export type StoryNotFound = {
    /** Whether to display the Downloader section */
    display: boolean;
    /** Title of the Downloader   */
    title: (storyId?: string) => React.ReactNode;
};
...
/**
 * CheckingOut page configuration.
 * @description Configuration for the CheckingOut page, including metadata, navigation label, and image list.
 */
export interface CheckingOut extends BasePageConfig {
}
 ...
 * @description Configuration for the CheckingOut page, including metadata, navigation label, and image list.
 */
export type NotFoundingStory = Omit<BasePageConfig, 'title'> & {
    title: (storyId?: string) => string;
}
